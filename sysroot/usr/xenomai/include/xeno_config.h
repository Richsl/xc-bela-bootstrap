...
/* config */
#define CONFIG_XENO_BUILD_ARGS " '--with-core=cobalt' '--enable-pshared' '--host=arm-linux-gnueabihf' '--build=arm' 'CFLAGS=-march=armv7-a -mfpu=vfp3' '--enable-dlopen-libs' 'build_alias=arm' 'host_alias=arm-linux-gnueabihf' 'CC=/home/giulio/bela-image-builder/downloads/ti-linux-kernel-dev/dl/gcc-linaro-5.5.0-2017.10-x86_64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf-gcc'"
